...
namespace Arduino_Temperature_Retrofit
{
    public partial class frmMain : Form
    {
        ...
        private void DataReceived(string information, string name)
        {
            ...
            if (information.Contains("|"))
            {
                try
                {
                    ...
                    int LengthData = ExtractIntFromString(information, "LEN", '|', ':');
                    int VersionNo = ExtractIntFromString(information, "VERSION", '|', ':');
        ...
        private void ProcessDataProtocolV1Ext(string[] data, ref DataObject dobj)
        {
            if (data.Length > 5)
            {
                dobj.addDataItem(DataObjectCategory.Luftfeuchtigkeit.Value, double.Parse(Common.replaceDecPoint(data[3].ToString())), DataObjectCategory.Luftfeuchtigkeit);
                dobj.addDataItem(DataObjectCategory.Temperatur.Value, double.Parse(Common.replaceDecPoint(data[4].ToString())), DataObjectCategory.Temperatur);
                dobj.addDataItem(DataObjectCategory.HeatIndex.Value, double.Parse(Common.replaceDecPoint(data[5].ToString())), DataObjectCategory.HeatIndex);
        ...
        private void ProcessDataProtocolV2Ext(string[] data, ref DataObject dobj)
        {
            if (data.Length > 6)
            {
                ...
                dobj.addDataItem(DataObjectCategory.Temperatur.Value, double.Parse(Common.replaceDecPoint(data[4].ToString())), DataObjectCategory.Temperatur);
                dobj.addDataItem(DataObjectCategory.HeatIndex.Value, double.Parse(Common.replaceDecPoint(data[5].ToString())), DataObjectCategory.HeatIndex);
                dobj.addDataItem(DataObjectCategory.Luftdruck.Value, double.Parse(Common.replaceDecPoint(data[6].ToString())), DataObjectCategory.Luftdruck);
        ...
        private void ProcessDataProtocolV3Ext(string[] data, ref DataObject dobj)
        {
            if (data.Length > 7)
            {
                ...
                dobj.addDataItem(DataObjectCategory.HeatIndex.Value, double.Parse(Common.replaceDecPoint(data[5].ToString())), DataObjectCategory.HeatIndex);
                dobj.addDataItem(DataObjectCategory.Luftdruck.Value, double.Parse(Common.replaceDecPoint(data[6].ToString())), DataObjectCategory.Luftdruck);
                dobj.addDataItem(DataObjectCategory.Lichtwert.Value, double.Parse(Common.replaceDecPoint(data[7].ToString())), DataObjectCategory.Lichtwert);
